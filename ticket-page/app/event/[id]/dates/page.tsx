      ...
      <div style={{ display: "flex", background: "white", borderBottom: "1px solid #ddd" }}>
        {(["CONCERTS", "ABOUT", "REVIEWS"] as Tab[]).map((tab) => (
          <button
            ...
            style={{
              flex: 1, padding: "14px 0", fontSize: 13, fontWeight: "bold",
              cursor: "pointer", background: "none", border: "none",
              borderBottom: activeTab === tab ? "3px solid #0050d0" : "3px solid transparent",
              color: activeTab === tab ? "#0050d0" : "#888", transition: "all 0.2s",
            }}
          >
            {tab}
          </button>
              ...
              <div key={event.id} style={{ borderBottom: "1px solid #e0e0e0", padding: "16px 20px", background: "white", marginBottom: 2 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <button style={{ border: "1px solid #bbb", borderRadius: 20, padding: "6px 14px", fontSize: 13, background: "white", cursor: "pointer", color: "#333", fontWeight: "500", display: "inline-flex", alignItems: "center", gap: 6 }}>
                      Reminders 🔔
                    </button>
                  </div>
                  <button
