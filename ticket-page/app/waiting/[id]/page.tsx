  ...
  useEffect(() => {
    ...
    const joinQueue = async () => {
      try {
        ...
        // Keep queue animation running even if Supabase write fails
      }
    };
              ...
              <div style={{ display: "flex", alignItems: "center", width: "100%" }}>
                ...
                <div
                  style={{
                    ...
                    height: 12,
                    borderRadius: "50%",
                    background: done ? "white" : "#555",
                    flexShrink: 0,
                  }}
                />
                {i < steps.length - 1 && (
                  <div style={{ flex: 1, height: 2, background: i < current ? "white" : "#555" }} />
                )}
              </div>
              <span
                style={{
      ...
      {showModal && (
        ...
        >
          ...
          >
            ...
            <p style={{ margin: "0 0 16px", color: "#333", lineHeight: 1.6 }}>
              By purchasing tickets to this event, you agree to abide by the health and safety measures
              in effect at the time of the event. Government mandates, venue protocols, and event
              requirements are subject to change.
            </p>
            <p style={{ margin: "0 0 24px", color: "#333", lineHeight: 1.6 }}>
              This event may have immersive elements, which may include flashing or strobe lights,
              intense lighting, visual effects, loud noises, smoke and/or fog.
            </p>
            <button
              onClick={handleAgree}
              style={{
